...
```php
/**
* @var \Spaire\Models\Errors\AlreadyActiveSubscriptionError
*/
...
```php
/**
* @var \Spaire\Models\Errors\NotOpenCheckout
*/
...
```php
/**
* @var \Spaire\Models\Errors\PaymentNotReady
*/
...
```php
/**
* @var \Spaire\Models\Errors\TrialAlreadyRedeemed
*/
