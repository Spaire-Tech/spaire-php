    ...
    public function create(Components\MemberSessionCreate $request, ?Options $options = null): Operations\MemberSessionsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Spaire\Models\Components\MemberSession', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
