...
class BenefitGitHubRepositoryProperties
{
     ...
     *
     * @var \Spaire\Models\Components\Permission $permission
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('permission')]
    #[\Speakeasy\Serializer\Annotation\Type('\Spaire\Models\Components\Permission')]
    public Permission $permission;

    /**
     * @param  string  $repositoryOwner
     * @param  string  $repositoryName
     * @param  \Spaire\Models\Components\Permission  $permission
     * @phpstan-pure
     */
