...
/** BalanceRefundEvent - An event created by Spaire when an order is refunded. */
class BalanceRefundEvent
{
    ...
    /**
     *
     * @var \Spaire\Models\Components\BalanceRefundMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Spaire\Models\Components\BalanceRefundMetadata  $metadata
