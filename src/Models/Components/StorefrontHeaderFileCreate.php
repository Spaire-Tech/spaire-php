...
class StorefrontHeaderFileCreate
{
    ...
    /**
     *
     * @var \Spaire\Models\Components\S3FileCreateMultipart $upload
     */
     ...
     * @param  int  $size
     * @param  \Spaire\Models\Components\S3FileCreateMultipart  $upload
     ...
     * @phpstan-pure
     */
    public function __construct(string $name, string $mimeType, int $size, S3FileCreateMultipart $upload, ?string $organizationId = null, ?string $checksumSha256Base64 = null, ?string $version = null, string $service = 'storefront_header')
    {
        $this->name = $name;
