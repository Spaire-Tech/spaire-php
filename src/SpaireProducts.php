...
class SpaireProducts
{
    ...
    public function previewTax(Components\ProductTaxPreviewRequest $request, ?Options $options = null): Operations\ProductsProductsPreviewTaxResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/products/tax-preview');
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'products:products:preview_tax', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Spaire\Models\Components\ProductTaxPreviewResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\ProductsProductsPreviewTaxResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    productTaxPreviewResponse: $obj);
